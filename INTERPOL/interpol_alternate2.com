...
set logg_list1 = (`awk '{if ($4 == '$met_min') print $0}' ${model_path}/grid.list | awk '{print $3}' | sort -u`)
set logg_list2 = ()
foreach loggmetmin ($logg_list1)
set logg_list2 = (`awk '{if ($4 == '$met_max' && $3 == '$loggmetmin') print $0}' ${model_path}/grid.list | awk '{print $3}' | sort -u` $logg_list2)
end
...
set Teff_list1 = (`awk '{if ($3 == '$logg_min' && $4 == '$met_min') print $2}' ${model_path}/grid.list`)
set Teff_list2 = ()
foreach Teffmetmin ($Teff_list1)
set Teff_list2 = (`awk '{if ($3 == '$logg_max' && $4 == '$met_min' && $2 == '$Teffmetmin') print $2}' ${model_path}/grid.list | sort -u` $Teff_list2)
end
set Teff_list3 = ()
foreach Teffmetmin ($Teff_list2 )
set Teff_list3 = (`awk '{if ($3 == '$logg_min' && $4 == '$met_max' && $2 == '$Teffmetmin') print $2}' ${model_path}/grid.list | sort -u` $Teff_list3)
end
set Teff_list4 = ()
foreach Teffmetmin ($Teff_list3 )
set Teff_list4 = (`awk '{if ($3 == '$logg_max' && $4 == '$met_max' && $2 == '$Teffmetmin') print $2}' ${model_path}/grid.list | sort -u` $Teff_list4)
end
set Teff_list = (`echo  $Teff_list4 | awk 'BEGIN{RS=" "}{print ('${Tref}' - $1)**2,$1}' | sort -u | sort -n | awk '{if ($1 == 0) print $2,$2; else if (NR == 1 || NR == 2) print $2}'`)
